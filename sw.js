...
const CACHE="medicina-ufmg-v9-planilha";
const FILES=["./","./index.html","./styles.css?v=9","./app.js?v=9","./eventos.json?v=9","./manifest.webmanifest?v=9","./icon.svg","./logo_medicina.svg"];
